...
## **6\. Задание 4 (Дополнительно/для продвинутых): Интеграция через ONVIF Profile C**

**Цель:** Освоить стандартный протокол интеграции между СКУД и СВН.

**Ход выполнения:**

1. Убедитесь, что ваше ПО СКУД поддерживает **ONVIF Profile C** (например, Genetec, Bosch).

2. В настройках СКУД укажите адрес VMS-сервера как получателя событий ONVIF.

3. В VMS добавьте устройство ONVIF Profile C (как “Generic Access Control Device”).

4. Настройте правила, аналогичные Заданию 2, но используя события ONVIF.

5. Протестируйте работу.

<note type="quote">

*Примечание: Не все VMS поддерживают Profile C в бесплатных версиях. Это задание -- для ознакомления со стандартом.*
...
3. **Используемое ПО** (названия, версии).

4. **Краткое описание выполненных заданий.**

5. **Скриншоты:**

   -  Окно настройки интеграции между VMS и СКУД.

   -  Настроенное правило “Успешный проход”.

   -  Настроенное правило “Несанкционированный доступ”.

   -  Архив видеозаписи с привязанным событием СКУД (с отображением метаданных: имя, карта, время).

   -  Пример email-уведомления (если настраивалось).

6. **Ответы на вопросы для самопроверки:**

   -  Почему важно тестировать соединение между системами перед настройкой правил?

   -  Почему важно записывать видео не только после, но и до события?

   -  Какие ещё действия можно настроить при событии СКУД?

7. **Выводы:**

   -  Какие сложности возникли при настройке интеграции?

   -  Почему интеграция СВН и СКУД -- ключевой элемент управления конфигурацией?

   -  Как полученные навыки пригодятся при выполнении курсового проекта?

---

## **8\. Контрольные вопросы (для защиты работы)**

1. Какие преимущества даёт интеграция СВН и СКУД по сравнению с их раздельной эксплуатацией?

2. Какие методы интеграции вы использовали? В чём их плюсы и минусы?

3. Что такое “предзапись” (pre-recording) и зачем она нужна?

4. Как обеспечивается синхронизация времени между системами? Почему это важно?

5. Какие типы событий СКУД могут инициировать действия в СВН?

6. Как интеграция влияет на требования к документированию конфигурации системы?